    ...
    function showTitle(event) {
        ...
        tooltipTimer = setTimeout(() => {
            ...
            if (titleElement) {
                ...
                tooltipElement.style.left = `${(rect.left - (rect.width / 2) - (tooltipElement.offsetWidth))}px`;
                tooltipElement.style.top = `${(rect.top + window.scrollY - tooltipElement.offsetHeight) - 50}px`;
